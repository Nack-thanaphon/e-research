...
// ส่งเมลหา user
       ...
       $mail_to_user->Host = 'smtp.gmail.com';    // Specify main and backup SMTP servers 
       //$mail_to_user->Host = 'ssl://smtp.googlemail.com';
	   $mail_to_user->SMTPAuth = true;    // Enable SMTP authentication
       $mail_to_user->SMTPDebug = 0;
	   $mail_to_user->Username = 'scia.eresearch@gmail.com';                 // SMTP username
	...
	//   $mail_to_user->Port = 465; google
       ...
       $mail_to_user->Subject = 'ทดสอบการส่งเมลจากเว็บ gmail';
