...
<body role="document" style="background: url('../images/<?if(defined('__EC_PICHOME__')){echo __EC_PICHOME__;}?>')  no-repeat; background-attachment:fixed;  background-size:auto;height:auto;width:auto;background-position: center;">
