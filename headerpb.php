 ...
 <nav class="navbar navbar-default" id="fmnavbar">
        <div class="container-fluid">
          <div class="navbar-header">
            ...
            <a href="./" title=""><img src="<?=_web_path;?>/images/<?if(defined('__EC_LOGO__')){echo __EC_LOGO__;}?>"  alt="ระบบคลังข้อมูลงานวิจัย"   style="padding-left:5px;padding-right:5px;max-height:50px"></a>
          </div>
