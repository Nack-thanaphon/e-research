...
// $Id: calendar-setup.js,v 1.1 2005/02/04 04:49:45 jeep Exp $
...
Calendar.setup = function (params) {
	...
	var tmp = ["inputField", "displayArea", "button", "inputField1", "inputField2", "inputField3"];
	for (var i in tmp) {
	...
	function onSelect(cal) {
		...
		if (cal.params.inputField) {
			tmp = cal.date.print(cal.params.ifFormat);
			//cal.params.inputField.value = tmp.substr(0,6) + (parseInt(tmp.substr(6,4)) + 543);
