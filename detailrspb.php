...
if($tRows > 0){
	...
	$numidcard = strlen($c_ec_idcard);
	$newidcard = "";
	if($numidcard >=5 ){
		$newidcard = substr($c_ec_idcard,0,$numidcard-4)."xxxx";
	}
	...
	<div class="row bgw2">
		...
		<!--<div class="col-lg-10 col-md-10 col-sm-10 col-xs-12 col-lg-offset-1 col-md-offset-1 col-sm-offset-1" style="padding-top:20px;padding-bottom:20px;">-->
			...
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				...
				<div class="col-lg-9 col-md-9 col-sm-9 col-xs-7 text-left"><?=$newidcard;?></div>
		    </div>
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				<div class="col-lg-3 col-md-3 col-sm-3 col-xs-5 text-right" style="font-weight: bold;">ส่วนงาน&nbsp;:&nbsp;</div>
				<div class="col-lg-9 col-md-9 col-sm-9 col-xs-7 text-left"><?=$c_ef_name;?></div>
			</div>
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
			...
			<table class="table table-striped table-bordered sticky-header" style="margin:0;padding:0;">
				...
				<tbody>
					...
					if($totalRows!="0")
					{
						...
						echo "<tr><td colspan=\"3\" style=\"text-align:center;color:#ff0000;\"><h4>...ไม่พบข้อมูล...</h4></td></tr>";
					}
					?>
				</tbody>
			</table>
