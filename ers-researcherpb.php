	...
	<div class="container-fluid">
		...
		<div class="row"><a name="top_page"></a>
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center" style="background-color:#<?php echo __EC_BGSHOW__; ?>;color:#<?php echo __EC_FONTSHOW__; ?>;">
				<h4 class="sub-header">นักวิจัย</h4>
			</div>
		...
		<div class="row" style="margin:0;padding:0;">
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				...
				<div class="col-lg-3 col-md-3 col-sm-3 col-xs-5 text-right">
					<form name="form3" method="post" action="ers-researcherpb.php?sd=<?= $sd; ?>&sh_order=<?= $sh_order; ?>&Page=1" role="form">
						...
						<input type="hidden" name="f_section_id" id="f_section_id" value="<?php if ($c_search_section) {
																								echo $c_search_section;
																							} else {
																								echo '';
																							} ?>">
						<input type="hidden" name="f_faculty_id" id="f_faculty_id" value="<?php if ($c_search_faculty) {
																								echo $c_search_faculty;
																							} else {
																								echo '';
																							} ?>">
						<input type="hidden" name="f_researcher_position_id" id="f_researcher_position_id" value="<?php if ($c_search_position) {
																														echo $c_search_position;
																													} else {
																														echo '';
																													} ?>">
					</form>
			...
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				<div align="center" style="padding-bottom:<?php if ($Per_Page == '18') {
																...
																echo "80px";
															} ?>;"><?php require_once "./admin/footer.php"; ?></div>
			</div>
		</div><!-- /.row -->
