...
<html lang="th" class="no-js">
  <head>
	...
	.cctop {padding-top:20px;}
	@media (max-width: 768px) {
		.hSelect {
			padding-top:60px;
			padding-bottom:10px;
		}
		.cctop {padding-top:40px;}
	}
	.ontop1 {z-index: 991;}	.ontop2 {z-index: 992;}	.ontop3 {z-index: 993;}	.ontop4 {z-index: 994;}	.ontop5 {z-index: 995;}
	.ontop6 {z-index: 996;}	.ontop7 {z-index: 997;}	.ontop8 {z-index: 998;}	.ontop9 {z-index: 999;}
...
<div class="container-fluid">
	...
	<div class="row"><a name="top_page"></a>
		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center" style="background-color:#<?echo __EC_BGSHOW__;?>;color:#<?echo __EC_FONTSHOW__;?>;"><h4 class="sub-header">ผลงานวิจัย</h4></div>
		...
		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
			...
			<div class="col-lg-3 col-md-3 col-sm-3 col-xs-5 text-right">
				<form name="form3" method="post" action="index.php?sd=<?=$sd;?>&sh_order=<?=$sh_order;?>&Page=1" role="form">
					...
					<input type="hidden" name="f_ed_year" id="f_ed_year" value="<? if($c_search_year){ echo $c_search_year;}else{ echo '';}?>">
				</form>
			</div>
		</div>

		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
			<div align="center" style="padding-bottom:<?if($Per_Page=='18'){echo "10px";}else{echo "80px";}?>;"><? require_once "./admin/footer.php"; ?></div>
	    </div>
	</div><!-- /.row -->
