					...
					$sql .= "and (`insert_date` = '".$s_date."') ";
							...
							if ($totalRows != "0") {
								...
								while ($result = $res->fetch_assoc()) {
									...
									$thlen2 = 100;
									if ($thlen > $thlen2) {
										$c_ed_name_th2 = $public_func->mb_substr($c_ed_name_th, 0, $thlen2) . "..";
									}
									...
									$enlen2 = 60;
									if ($enlen > $enlen2) {
										$c_ed_name_en2 = $public_func->mb_substr($c_ed_name_en, 0, $enlen2) . "..";
									}
									...
									$ttlen2 = 70;
									if ($ttlen > $ttlen2) {
										$c_ed_detail2 = $public_func->mb_substr($c_ed_detail, 0, $ttlen2) . "..";
									}
									...
									if ($nRows_d > 0) {
										...
										$eslen2 = 30;
										if ($eslen > $eslen2) {
											$c_es_name2 = $public_func->mb_substr($c_es_name, 0, $eslen2) . "..";
										}
									}
									...
									if ($nRows_d > 0) {
										...
										$eflen2 = 30;
										if ($eflen > $eflen2) {
											$c_ef_name2 = $public_func->mb_substr($c_ef_name, 0, $eflen2) . "..";
										}
									}
