...
{	
	...
	$s_title_th = "";
	if($s_title_th_v=="1"){$s_title_th = "นาย";}
	if($s_title_th_v=="2"){$s_title_th = "นาง";}
	if($s_title_th_v=="3"){$s_title_th = "นางสาว";}
	if($s_title_th_v=="4"){$s_title_th = $_POST["s_title_th_other"];}
	...
	$s_title_en = "";
	if($s_title_en_v=="1"){$s_title_en = "Mr.";}
	if($s_title_en_v=="2"){$s_title_en = "Mrs.";}
	if($s_title_en_v=="3"){$s_title_en = "Miss";}
	if($s_title_en_v=="4"){$s_title_en = $_POST["s_title_en_other"];}
...
if(isset($c_id)){
	if($c_id!=''){
		...
		if($tRows>0){
			...
			if($c_title_en=="Mr."){ $c_title_en_v = '1';} elseif($c_title_en=="Mrs."){ $c_title_en_v = '2';} elseif($c_title_en=="Miss"){ $c_title_en_v = '3';} elseif(!empty($c_title_en)){ $c_title_en_v = '4';}		
...
<html lang="th" class="no-js">
  <head>
	...
	<style>
	.col-lg-12 ,.col-lg-8 ,.col-lg-6 ,.col-lg-4 { margin:0;padding:0; }
	.col-md-12 ,.col-md-8 ,.col-md-6 ,.col-md-4 { margin:0;padding:0; }
	.col-sm-12 ,.col-sm-8 ,.col-sm-6 ,.col-sm-4 { margin:0;padding:0; }
	</style>
<script LANGUAGE="JavaScript">
function c_check(){
		...
		<form name="form2" method="post" action="researcher.php#top_page" onSubmit="return c_check2();" role="form">
		  ...
		  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
			...
			switch ($sd) {
				...
				case '3': $sql .= "Order by `ec_phone` "; break;
				case '4': $sql .= "Order by `ec_mobile` "; break;
				case '5': $sql .= "Order by `ec_email` "; break;
				case '6': $sql .= "Order by `section_id` "; break;
				case '7': $sql .= "Order by `faculty_id` "; break;
				case '8': $sql .= "Order by `researcher_position_id` "; break;
